...
VIDEO_CARDS="${RADEON_CARDS} d3d12 freedreno intel lavapipe lima nouveau panfrost v3d vc4 virgl vivante vmware xe"
...
multilib_src_configure() {
	...
	if use video_cards_xe; then
		emesonargs+=(-Dintel-xe-kmd=enabled)
	else
		emesonargs+=(-Dintel-xe-kmd=disabled)
	fi
