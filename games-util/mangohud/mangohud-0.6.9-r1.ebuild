...
LICENSE="MIT"
SLOT="0"
IUSE="+dbus debug tools +X xnvctrl wayland video_cards_nvidia video_cards_intel"
...
pkg_postinst() {
	if use video_cards_intel; then
		einfo ""
		einfo "`sudo setcap cap_perfmon=+ep /usr/bin/intel_gpu_top` is required"
		einfo ""
		einfo "https://gitlab.freedesktop.org/drm/intel/-/issues/5018#note_1455627"
		einfo ""
	fi
